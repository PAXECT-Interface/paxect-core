...
|--------------------------|-----------------------------|-----------------------------------------------|------------|
| PAXECT AES Secure Plugin | Confidentiality & authenticity | AES-256 GCM/CTR, scrypt KDF, AAD, strict fail | [Repo](https://github.com/PAXECT-Interface/paxect-aes-plugin) |
| PAXECT Polyglot Plugin   | Language bindings           | Python, Node.js, Go, C/C++, Java, C#, PHP…    | [Repo](https://github.com/PAXECT-Interface/paxect-polyglot-plugin) |
| PAXECT SelfTune 5-in-1   | Performance & observability | Guard, overhead, logging, smoothing, auto-learning | [Repo](https://github.com/PAXECT-Interface/paxect-selftune-5in1) |
...
### Free Base Tier (OSS) — First 6 Months

- **All features are free for the first 6 months after launch**, including Enterprise/Pro features.
...
- At least 30 days before the end of the 6-month free period, we will announce which features will remain free and which may move to Enterprise/Pro.
- The open-source core will always remain free and maintained.

### Enterprise/Pro (after free period)

- **Performance & Ops:** SelfTune 5-in-1 (guard, overhead, logging, smoothing, auto-learning)
- **Security & Compliance:** HSM/KMS integration, FIPS modes, compliance/audit logging
- **Languages:** Java (JNI), C#/.NET (P/Invoke); optional “enhanced” features for Python/Node/Go
...
Questions or collaboration: **contact@paxect.io** or open a 
[GitHub Issue](https://github.com/PAXECT-Interface/PAXECT---Core/issues) /
[Discussion](https://github.com/PAXECT-Interface/PAXECT---Core/discussions).
